...
class SavedQueries:
    ...
    OPEN_ISSUES = 'project = {project} AND status IN ("Open", "Ready to Dev") ORDER BY priority DESC, updated DESC'
    """All issues that are Open or Ready to Dev in the specified project (regardless of assignee), ordered by priority and last updated"""
